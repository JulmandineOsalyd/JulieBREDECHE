...
- **Une application Power Apps** pour répondre aux mails directement depuis l'application, sans repasser par Outlook. Les agents restent dans un seul outil, de bout en bout.
