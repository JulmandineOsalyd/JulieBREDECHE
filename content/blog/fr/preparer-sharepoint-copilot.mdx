...
metaTitle: "Préparer SharePoint pour Copilot : 2 astuces JSON"
metaDescription: "2 colonnes SharePoint formatées en JSON pour préparer Copilot : maîtriser le partage et identifier les connaissances clés. Le terrain avant le déploiement."
