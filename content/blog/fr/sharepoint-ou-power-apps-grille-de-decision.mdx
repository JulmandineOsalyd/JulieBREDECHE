...
⚠️ Power Apps est inclus dans toutes les licences Microsoft 365. Dataverse et les connecteurs premium nécessitent une licence supplémentaire.
...
| Formulaire avec calculs et champs conditionnels| ❌ &nbsp; Non | ✅ &nbsp; Oui |
| Formulaire multi-écrans | ❌ &nbsp; Non | ✅ &nbsp; Oui |
| Formulaire avec des règles de validation avancées | ❌ &nbsp; Non | ✅ &nbsp; Oui |
| Liste de suivi avec vues filtrées | ✅ &nbsp; Oui | ✅ &nbsp; Oui |
| Dashboard avancé filtré par profil | ❌ &nbsp; Non | ✅ &nbsp; Oui |
| Déclenchement de flux Power Automate | ✅ &nbsp; Oui | ✅ &nbsp; Oui |
| Bouton pour déclencher un flux manuellement | ⚠️ &nbsp; Limité | ✅ &nbsp; Oui |
| Gestion des actions par profil | ⚠️ &nbsp; Limité | ✅ &nbsp; Oui |
