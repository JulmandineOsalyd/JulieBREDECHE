...
Et finalement, le développement d'un flux dans un projet d'automanisation, c'est rarement là où se jouent les vrais enjeux.
...
Quand un client me dit *"on veut automatiser la saisie de nos bons de commande"*, ce n'est pas une description de flux. C'est un point de départ.
...
Copilot peut aider à développer une solution, mais un expert participe aussi à **l'adoption du projet**.
